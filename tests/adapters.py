...
def run_linear(
    ...
    y_hat = linear_module.forward(in_features)
    return y_hat
...
def run_embedding(
    ...
    y_hat = embedding_module.forward(token_ids)
    return y_hat
...
def run_rope(
    ...
    y_hat = rope.forward(in_query_or_key, token_positions)
    return y_hat
...
def run_transformer_lm(
    ...
    """
    transformer = TransformerLM(d_model, num_heads, d_ff, vocab_size, context_length, num_layers, rope_theta)
